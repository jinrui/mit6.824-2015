...
type MapReduce struct {
	...
	WorkersState chan string
	AllWorkDone  chan bool
	mrLock       chan int
}
...
func InitMapReduce(nmap int, nreduce int,
	...
	mr.WorkersState = make(chan string, mr.nMap+mr.nReduce)
	mr.mrLock = make(chan int)
	mr.AllWorkDone = make(chan bool, mr.nMap+mr.nReduce)
	return mr
}
